...
from models import YOLOv12n

def submission_3_20214173(yaml_path, output_json_path):
    ...
    model = YOLO("yolov12n.yaml", verbose=False)
   
    os.makedirs(output_dir, exist_ok=True)
    ex_dict['Model Name'] = model_name; ex_dict['Model']=model; 
    ex_dict = YOLOv12n.train_model(ex_dict)
